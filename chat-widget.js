...
(function () {
  ...
  var CSS_TEXT = "\n"
    ...
    + ".vc-faq-item { background: #182238; border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 10px; overflow: hidden; align-self: stretch; }\n"
    + ".vc-faq-q { padding: 11px 14px; font-size: 0.88rem; font-weight: 600; cursor: pointer; display: flex; justify-content: space-between; align-items: center; color: #eef1f8; }\n"
    + ".vc-faq-q::after { content: '+'; color: #4f7fff; font-weight: 700; font-size: 1.1rem; transition: transform 0.2s ease; }\n"
